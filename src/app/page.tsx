...
export default async function HomePage() {
  ...
  return (
    <>
      ...
      {/* Why Choose Us */}
      <section className="max-w-6xl mx-auto px-5 sm:px-6 mb-16">
        <h2 className="text-lg font-semibold text-[var(--text-primary)] mb-6">Why families choose us</h2>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
          <div className="glass rounded-xl p-5 card-hover">
            ...
            <p className="text-xs text-[var(--text-muted)] leading-relaxed">Every listing is personally verified. What you see is what you get.</p>
          </div>
          <div className="glass rounded-xl p-5 card-hover">
            <div className="w-10 h-10 rounded-lg bg-[var(--accent-soft)] flex items-center justify-center mb-3">
              <svg className="w-5 h-5 text-[var(--accent)]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <p className="text-xs text-[var(--text-muted)] leading-relaxed">No hidden charges or surprise fees. The price you see is the price you pay.</p>
          </div>
          <div className="glass rounded-xl p-5 card-hover">
            <div className="w-10 h-10 rounded-lg bg-[var(--accent-soft)] flex items-center justify-center mb-3">
              <svg className="w-5 h-5 text-[var(--accent)]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <p className="text-xs text-[var(--text-muted)] leading-relaxed">10+ years in Kanjirapally. We know every neighborhood and its value.</p>
          </div>
          <div className="glass rounded-xl p-5 card-hover">
            ...
            <h3 className="text-sm font-semibold text-[var(--text-primary)] mb-1">WhatsApp Support</h3>
            <p className="text-xs text-[var(--text-muted)] leading-relaxed">Quick replies on WhatsApp. Ask about any property and get instant details.</p>
          </div>
        </div>
      </section>
